...
public class GoogleCredential {
    private final String APPLICATION_NAME = BotConfiguration.getGoogleApplicationName();
    private final JsonFactory JSON_FACTORY = GsonFactory.getDefaultInstance();
    private final String CREDENTIALS_FILE_PATH  = BotConfiguration.getGoogleServiceAccountKeyPath();
