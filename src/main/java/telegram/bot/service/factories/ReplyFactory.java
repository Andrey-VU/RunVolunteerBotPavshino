...
public class ReplyFactory {
    ...
    private static final String REGISTRATION_INITIAL_MESSAGE = "Для регистрации необходимы Имя, Фамилия,  и ваш id 5 верст";
    ...
    private static final String ENTER_5VERST_CODE_MESSAGE = "Введите код 5 верст (только 9 цифр)";
    ...
    private static final String REGISTRATION_CANCEL_MESSAGE = "Запись отменена";
    ...
    private static final String INFORM_ORG_JOIN_VOLUNTEERS_MESSAGE = " записан(а) в волонтеры на позицию ";
